...
const CLIENT_ID = "2781436527-2n19i4dudkhf5fhddkoejg4f66hrk4l5.apps.googleusercontent.com";
...
function updateSigninStatus(isSignedIn) {
    if (isSignedIn) {
        console.log("Can write data to database");
    }
}
...
function endScene() {
    ...
    endScene.prototype.setup = function() {
        ...
        let str_date = h+"/"+min+"/"+sec+" "+dd+"/"+mm+"/"+yyyy;

        var values = [
            [
                str_date, name.toString(), score.toString(), minute + ":" + second
            ],
        ];
        var body = {
            values: values
        ...
        gapi.client.sheets.spreadsheets.values.append({
            spreadsheetId: "1gPIK-qFtBSAUlZTSmQubwfqp30eRdNIY4lw6NMMD3RE",
            range: "data!A2:D2",
